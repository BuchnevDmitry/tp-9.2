...
| Логин         |       Пароль        |
| ------------- | ------------------- |
| fake_admin    |   strongpassword    |

P.S.: Данный администратор может только просматривать админ-панель, для доступа к аккаунту администратора с полным функционалом обращайтесь к следующим людям: [Дмитрий Бучнев VK ](https://vk.com/dima_buchnev) [Вадим Ремезов VK](https://vk.com/bitchofson)
